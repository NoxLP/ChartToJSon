...
namespace Petzold.Media2D
{
    ...
    /// </summary>
    public abstract class ArrowLineBase : Shape, INotifyPropertyChanged
    {
        /// <summary>
        ...
        //                OnArrowEndsPropertyChanged));
        //private static void OnArrowEndsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        //{
        //    ((ArrowLineBase)d).OnArrowEndsChanged((ArrowEnds)e.NewValue);
        //}
        //private void OnArrowEndsChanged(ArrowEnds arrowEnds)
        //{
        //    UpdateLayout();
        //}
