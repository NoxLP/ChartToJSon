...
namespace ChartCanvasNamespace.ZoomAndPanModel
{
    /// <summary>
    ...
    /// </summary>
    public class ZoomAndPanDataModel : INotifyPropertyChanged
    {
        #region Data Members
        ...
        /// </summary>
        private static ZoomAndPanDataModel instance = new ZoomAndPanDataModel();
        ...
        /// </summary>
        public static ZoomAndPanDataModel Instance
        {
            get
            {
                return instance;
